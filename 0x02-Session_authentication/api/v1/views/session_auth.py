...
session_auth_bp = Blueprint('session_auth', __name__, url_prefix='/auth_session')
...
def login():
    ...
    Returns:
        ...
        JSON response with error message and appropriate status code for invalid login attempts.
    """
